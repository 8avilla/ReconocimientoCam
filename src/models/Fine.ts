...
export const FINE_TYPES = ["yellow_card", "red_card", "manual"] as const;
...
/**
 * A fine charged to a team (usually for a player's card). Card fines are created from the match events
 * when the championship sets an amount; the organizer registers the payments received (partial ones allowed).
 */
