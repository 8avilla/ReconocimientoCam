    ...
    <div className={`${styles.offscreen} print-target`}>
      <article className={styles.card} aria-label={`Carnet para imprimir de ${card.fullName}`}>
        ...
        {card.championship && (
          <div className={styles.champBadge}>
            {card.championship.logoUrl ? (
              <span className={styles.champLogo} aria-hidden style={{ backgroundImage: `url("${card.championship.logoUrl}")` }} />
            ) : (
        ...
        {card.photoUrl ? (
          ...
          <span className={styles.photo} aria-hidden style={{ backgroundImage: `url("${card.photoUrl}")` }} />
        ) : (
        ...
        <div className={styles.info}>
          ...
          {card.team && (
            <div className={styles.team}>
              <span className={styles.teamLogo} aria-hidden style={{ backgroundImage: `url("${card.team.shieldUrl}")` }} />
              <div>
